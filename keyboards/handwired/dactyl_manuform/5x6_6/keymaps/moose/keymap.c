...
#define HYPRT HYPR_T(KC_T)

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT_5x6(
        KC_EQL , KC_1  , KC_2  , KC_3  , KC_4 , KC_5  ,                         KC_6  ,  KC_7  ,  KC_8  ,  KC_9  , KC_0  ,  KC_MINS,
        KC_TAB , KC_Q , KC_W  , EMODT , RMODT , HYPRT ,                         KC_Y  ,  KC_U  ,  KC_I  ,  KC_O  , KC_P  ,  KC_BSLS,
        CAPST  , HRL1  , HRL2  , HRL3  , HRL4 , KC_G  ,                         KC_H  ,  HRR1  ,  HRR2  ,  HRR3  , HRR4  ,  KC_QUOT,
        KC_LSFT, KC_Z  , KC_X  , KC_C  , KC_V , KC_B  ,                         KC_N  ,  KC_M  , KC_COMM, KC_DOT , KC_SLSH, KC_RSFT,
                 KC_GRV, KC_INS,KC_LEFT,KC_RGHT,                                          KC_UP, KC_DOWN ,KC_LBRC, KC_RBRC,

                                       KC_LCTL, KC_LALT,                        MOD_RGUI, KC_ESC,
                                                _______,                        TT(LOWER),
                                KC_BSPC, KC_DEL, KC_HOME,                       KC_END, KC_ENTER, SPCET
    ),
    ...
    [_MOOSE] = LAYOUT_5x6(
          ...
          KC_F12 ,_______,KC_MUTE,KC_VOLD,KC_VOLU,_______,                        _______,_______,KC_PGUP,_______,_______,_______,
          _______,_______,KC_MPLY,KC_MPRV,KC_MNXT,_______,                        KC_HOME, KC_LEFT,KC_UP ,KC_DOWN,KC_RIGHT,KC_END,
