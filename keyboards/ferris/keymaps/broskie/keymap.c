...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT( /* [> LOWER <] */
    ...
    KC_GESC, KC_HOME, LSFT_T(KC_END), KC_PGUP, KC_PGDN,  KC_MINS, KC_EQL,  LSFT_T(KC_LPRN), KC_RPRN, KC_QUOT,
  ...
  [_RAISE] = LAYOUT( /* [> RAISE <] */
    ...
    _______, _______, _______, _______, _______,         KC_PIPE, _______, _______, _______, KC_ENT,
